                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" placeholder="Input Here"
                                        ...
                                        name="nama" value="{{ old('nama', $gedung->nama) }}">
                                    @error('nama')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="0" placeholder="0"
                                        ...
                                        name="ongkir" value="{{ old('ongkir', $gedung->ongkir) }}">
                                    @error('ongkir')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="0" placeholder="0"
                                        class="form-control @error('ongkir_multitenant') is-invalid @enderror"
                                        id="ongkir_multitenant" name="ongkir_multitenant"
                                        value="{{ old('ongkir_multitenant', $gedung->ongkir_multitenant) }}">
